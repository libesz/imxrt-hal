...
// SAI
use crate::sai;
use super::sai::Packing;

// Safety: a SAI can provide data for a DMA transfer. Its receive data register
// points to static memory.
unsafe impl<const N: u8, const WORD_SIZE: u8, const FRAME_SIZE: usize, PACKING: Packing<WORD_SIZE>> peripheral::Source<u32> for sai::Rx<N, WORD_SIZE, FRAME_SIZE, PACKING> {
    fn source_signal(&self) -> u32 {
...
// Safety: a SAI can receive data for a DMA transfer. Its transmit data register
// points to static memory.
unsafe impl<const N: u8, const WORD_SIZE: u8, const FRAME_SIZE: usize, PACKING: Packing<WORD_SIZE>> peripheral::Destination<u32> for sai::Tx<N, WORD_SIZE, FRAME_SIZE, PACKING> {
    fn destination_signal(&self) -> u32 {
